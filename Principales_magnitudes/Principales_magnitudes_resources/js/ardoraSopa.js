...
paintImaDivs($(this).position().left+sizeCell,$(this).position().top,"Principales_magnitudes_resources/media/i1_arton42859.jpg","");
...
paintImaDivs($(this).position().left+sizeCell,$(this).position().top,"Principales_magnitudes_resources/media/i2_viejos-un-hectogramos-de-peso-24859786.jpg","");
}, function() {$(this).css("cursor","auto");var canvas = document.getElementById("ardoraActSel");var context = canvas.getContext("2d");canvas.width=canvas.width;$("#ardoraActSel").attr("aria-label","");});
$("#idDiv2").hover(function(){$(this).css("cursor","pointer");
paintImaDivs($(this).position().left+sizeCell,$(this).position().top,"Principales_magnitudes_resources/media/i3_gramos-de-s__mbolo-del-cuenco-121735153.jpg","");
}, function() {$(this).css("cursor","auto");var canvas = document.getElementById("ardoraActSel");var context = canvas.getContext("2d");canvas.width=canvas.width;$("#ardoraActSel").attr("aria-label","");});
$("#idDiv3").hover(function(){$(this).css("cursor","pointer");
paintImaDivs($(this).position().left+sizeCell,$(this).position().top,"Principales_magnitudes_resources/media/i4_hora-de-alarma-de-tiempo-de-reloj-de-dibujos-animados-hrm8rb.jpg","");
}, function() {$(this).css("cursor","auto");var canvas = document.getElementById("ardoraActSel");var context = canvas.getContext("2d");canvas.width=canvas.width;$("#ardoraActSel").attr("aria-label","");});
$("#idDiv4").hover(function(){$(this).css("cursor","pointer");
paintImaDivs($(this).position().left+sizeCell,$(this).position().top,"Principales_magnitudes_resources/media/i5_clock-vector-cartoon-png_187540.jpg","");
}, function() {$(this).css("cursor","auto");var canvas = document.getElementById("ardoraActSel");var context = canvas.getContext("2d");canvas.width=canvas.width;$("#ardoraActSel").attr("aria-label","");});
$("#idDiv5").hover(function(){$(this).css("cursor","pointer");
paintImaDivs($(this).position().left+sizeCell,$(this).position().top,"Principales_magnitudes_resources/media/i6_el-icono-de-minutos-aislado-en-fondo-reloj-y-watc-blancos-133736508.jpg","");
}, function() {$(this).css("cursor","auto");var canvas = document.getElementById("ardoraActSel");var context = canvas.getContext("2d");canvas.width=canvas.width;$("#ardoraActSel").attr("aria-label","");});
$("#idDiv6").hover(function(){$(this).css("cursor","pointer");
paintImaDivs($(this).position().left+sizeCell,$(this).position().top,"Principales_magnitudes_resources/media/i7_istockphoto-1285211353-612x612.jpg","");
}, function() {$(this).css("cursor","auto");var canvas = document.getElementById("ardoraActSel");var context = canvas.getContext("2d");canvas.width=canvas.width;$("#ardoraActSel").attr("aria-label","");});
$("#idDiv7").hover(function(){$(this).css("cursor","pointer");
paintImaDivs($(this).position().left+sizeCell,$(this).position().top,"Principales_magnitudes_resources/media/i8_indicador-amarillo-nueva-condicion-gj4twk.jpg","");
}, function() {$(this).css("cursor","auto");var canvas = document.getElementById("ardoraActSel");var context = canvas.getContext("2d");canvas.width=canvas.width;$("#ardoraActSel").attr("aria-label","");});
$("#idDiv8").hover(function(){$(this).css("cursor","pointer");
paintImaDivs($(this).position().left+sizeCell,$(this).position().top,"Principales_magnitudes_resources/media/i9_herramienta-de-medici__n-del-medidor-bolsillo-plegable-amarillo-ilustraci__n-vectorial-la-aislado-en-un-fondo-blanco-dise__o-plano-235405311.jpg","");
}, function() {$(this).css("cursor","auto");var canvas = document.getElementById("ardoraActSel");var context = canvas.getContext("2d");canvas.width=canvas.width;$("#ardoraActSel").attr("aria-label","");});
$("#idDiv9").hover(function(){$(this).css("cursor","pointer");
paintImaDivs($(this).position().left+sizeCell,$(this).position().top,"Principales_magnitudes_resources/media/i10_s__mbolo-del-__tomo-16466824.jpg","");
}, function() {$(this).css("cursor","auto");var canvas = document.getElementById("ardoraActSel");var context = canvas.getContext("2d");canvas.width=canvas.width;$("#ardoraActSel").attr("aria-label","");});
$("#idDiv10").hover(function(){$(this).css("cursor","pointer");
paintImaDivs($(this).position().left+sizeCell,$(this).position().top,"Principales_magnitudes_resources/media/i11_mol__cula-de-agua-9227268.jpg","");
}, function() {$(this).css("cursor","auto");var canvas = document.getElementById("ardoraActSel");var context = canvas.getContext("2d");canvas.width=canvas.width;$("#ardoraActSel").attr("aria-label","");});
$("#idDiv11").hover(function(){$(this).css("cursor","pointer");
paintImaDivs($(this).position().left+sizeCell,$(this).position().top,"Principales_magnitudes_resources/media/i12_icono-de-grado-celsius-diseno-reflejo-de-sombra-ilustracion-vectorial-gjpdbc.jpg","");
}, function() {$(this).css("cursor","auto");var canvas = document.getElementById("ardoraActSel");var context = canvas.getContext("2d");canvas.width=canvas.width;$("#ardoraActSel").attr("aria-label","");});
$("#idDiv12").hover(function(){$(this).css("cursor","pointer");
paintImaDivs($(this).position().left+sizeCell,$(this).position().top,"Principales_magnitudes_resources/media/i13_Raumthermometer_Fahrenheit_Celsius.jpg","");
}, function() {$(this).css("cursor","auto");var canvas = document.getElementById("ardoraActSel");var context = canvas.getContext("2d");canvas.width=canvas.width;$("#ardoraActSel").attr("aria-label","");});
$("#idDiv13").hover(function(){$(this).css("cursor","pointer");
paintImaDivs($(this).position().left+sizeCell,$(this).position().top,"Principales_magnitudes_resources/media/i14_Amperimetor-medidor-amperios.jpg","");
}, function() {$(this).css("cursor","auto");var canvas = document.getElementById("ardoraActSel");var context = canvas.getContext("2d");canvas.width=canvas.width;$("#ardoraActSel").attr("aria-label","");});
$("#idDiv14").hover(function(){$(this).css("cursor","pointer");
paintImaDivs($(this).position().left+sizeCell,$(this).position().top,"Principales_magnitudes_resources/media/i15_voltio_tu_nuevo_carsharing_madrid_electrico_compartir_coche_1c4dd51fbf.jpg","");
}, function() {$(this).css("cursor","auto");var canvas = document.getElementById("ardoraActSel");var context = canvas.getContext("2d");canvas.width=canvas.width;$("#ardoraActSel").attr("aria-label","");});
}
